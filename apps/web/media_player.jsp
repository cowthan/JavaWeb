...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>resource/css/detail_p.css">
	<script src="<%=basePath%>resource/js/jquery-1.12.1.min.js"></script>
</head>
	...
	<div class="video_b" style="margin-top:0">
		<div class="video_b_in">
			<div class="video_ls">
				...
				<!--暂停-->
				<div id="pass">
					<img src="<%=basePath %>/resource/img/zt.png">
				</div>
				<!--控制器-->
				<div class="controls">
					<!--进度条容器-->
			...
			<div class="video_rs">
				...
				<div class="video_rs_b">
					<!--一条-->
					<div class="one_tb" vid_src="<%=basePath %>${media.src }">
						<span class="one_tb_l">1</span>
						<div class="one_tb_c">
							<img src="<%=basePath%>resource/img/timg.jpg">
							<b></b>
						</div>
						<div class="one_tb_r">
							<h3>视频标题</h3>
