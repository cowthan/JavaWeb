...
import com.ayo.zbd.service.RobotCmdMybatisService;
...
public class CmdListMybatisRouter extends RouterHandler {
    ...
    public void doAction(String method, HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<CmdModel> list = new RobotCmdMybatisService().queryRobotCmdList(keyCmd, keyDesc);
